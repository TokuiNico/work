...
int main(int argc, char *argv[]){		
	...
	for(int iW=0; iW<numW; iW++){
		...
		gettime(&end);
	   //cout<<"Start = ";
	   //cout<<double(start.ti_hour)<<" : "<<double(start.ti_min)<<" : "<<double(start.ti_sec)<<" : "<<double(start.ti_hund)<<endl;  //hund : hundredths of seconds
	   //cout<<"End = ";
	   //cout<<double(end.ti_hour)<<" : "<<double(end.ti_min)<<" : "<<double(end.ti_sec)<<" : "<<double(end.ti_hund)<<endl;
	   double runtime;
